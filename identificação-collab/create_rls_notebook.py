 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    ")\n",
    "\n",
    "u_TRA,  y_TRA  = carregar_experimento(BASE + \"step_35_open.csv\")\n",
    "u_TEST, y_TEST = carregar_experimento(BASE + \"step_39_open.csv\")\n",
    "\n",
...
with open("c:\\\\Users\\\\vicio\\\\Documents\\\\SYSTEM-IDENTIFICATION-AERO-main\\\\identificação-collab\\\\RLS_AEROPENDULO.ipynb", "w", encoding="utf-8") as f:
